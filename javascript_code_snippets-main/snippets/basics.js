...
let names = ["pavan", "Sanjay", "Ganesh", "Sachin"];
...
const employees = [{ name: "pavan", empId: 1 }, { name: "Dixit", empId: 2 },]

const { 0: emp1, 1: emp2 } = employees;

console.log(emp1) // { name: 'pavan', empId: 1 }
...
const dev = { id: 1, name: "pavan", city: "Hubballi", role: "Dev" };

console.log(dev) // { id: 1, name: 'pavan', city: 'Hubballi', role: 'Dev' }
console.log(JSON.stringify(dev)) // {"id":1,"name":"pavan","city":"Hubballi","role":"Dev"}
...
const neoEmp = { name: "pavan", designation: "Solutions Architect", id: 100, salary: 50000 }
...
console.log(joinFirstLastName2(person)); // pavan-D
...
//Strings
const strArr = ["pavan", "Sachin", "Guru", "Nirmal"];
strArr.sort();
console.log(strArr); // [ 'Guru', 'pavan', 'Nirmal', 'Sachin' ]
//Numbers
